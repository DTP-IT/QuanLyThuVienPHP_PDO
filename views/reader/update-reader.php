				...
				<div class="p-sm-4 bg-white rounded-sm shadow-sm">				
					<div class="my-md-4 table-responsive">
						...
						foreach ($result as $key => $value) {
							?>
							<form action="index.php?page=list-readers&method=update" method="POST" enctype="multipart/form-data" name="register" onsubmit="return registerReader();">
								<center>
									...
									<table border="1" class="table table-hover">
										<tr>
											...
											<td>
												<input type="text" name="id" id="id" size="20" required value="<?php echo $value['maThe'] ?>" />
										...
										<tr>
											...
											<td>
												<input type="text" name="name" id="name" size="20" required value="<?php echo $value['hoTen'] ?>" />
										...
										<tr>
											<td>Địa chỉ</td>
											<td>
												<textarea name="address" cols="20" rows="4" ><?php echo $value['diaChi'];?></textarea>
											</td>
										</tr>
										<tr>
											<td>Ảnh</td>
										...
										<tr>
											...
											<td>
												<input type="text" name="phone" id="phone" size="20" required value="<?php echo $value['SDT'] ?>" />
										...
										<tr>
											...
											<td>
												<input type="text" name="email" id="email" size="20" required value="<?php echo $value['email'];?>" />
