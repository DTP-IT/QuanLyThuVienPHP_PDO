        ...
        <div class="col-md-12 ">
            <div class="p-sm-4 bg-white rounded-sm shadow-sm">
                <div class="my-md-4 table-responsive">  
                    <form action="index.php?page=reader-year&method=reader-year" method="POST">
                     <table>
                        <tr>
                         <td> Từ năm</td>
                         <td><input type="year" name="startYear"  value="<?php if(isset($_POST['btnReaderYear'])){echo $_POST['startYear'];}?>" /></td>
                     </tr>
                     <tr>
                         <td> đến năm</td>
                         <td><input type="year" name="finishYear" value="<?php if(isset($_POST['btnReaderYear'])){echo $_POST['finishYear'];}?>" /></td>
                     </tr>
                     <tr>
                        <td colspan="2">
                            <button type="submit" class="btn btn-success" data-toggle="button" aria-pressed="false" autocomplete="off" name="btnReaderYear">Thống kê</button>
                        </td>
                    </tr>
                </table>   
            </form>
